...
label day1:
  ...
  "It always takes a long time; now and again I wish I had lovely sleek short hair like the other kids do."
  "My long-haired trait captures so much dust and dirt around my tail, sometimes it looks like I've been trying to sweep all of it up off the floor."
  "When that's done, I sit at my desk, stretching, and thinking about drawing for a bit. A warm-up practice would be good for me, and who knows what I'll find when I get to breakfast."
...
label breakfastday1:
  ...
  "The cafeteria is already bustling with kids, the chatter of their voices and the delicious smell of maple mingling together. I bet that today will be just as sweet as these pancakes."
  ...
  "Most of the kids are bushy tailed and bright, having gotten a rest after yesterday's loss, and eagerly shoveling down the tasty breakfast. There's no way I wouldn't follow suit."
  "Chatting idly with the kids at my table and stuffing my face with some fluffy pancakes makes me a little slow to notice the tone of their chatters changing so suddenly."
  ...
  "We only know when they don't show up for breakfast. I'll have to find out who it is, and help the kids feel comfortable without their friend again today."
  ...
  "But we never know who, and we never know when. It makes it hard for the kids who have grown close over the years."
  ...
  "The kids shuffle around but nod, knowing what I say is true but they are still upset about losing their friend."
  ...
  "When it finally does, I quickly slip away from the children and scamper down the hallway in the other direction."
  ...
  a "Ali was adopted this morning, some of the kids are sad about it. It's nothing new."
  ...
  "I didn't say anything, but I wait until the lesson is over when and it's work time. Then I can go help out anyone who raises their hand."
  "I'm not very good at math, so I'm not as much help today as I am on different days. But I'll always do my best."
  ...
  "Tucking them to bed is easy. I also finally spot Pumpkin again, but I decided not to bother him this late. He slides into bed just like the other kids are doing, and I turn out the lights as I leave."
