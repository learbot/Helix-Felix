...
label day2:
  ...
  "This morning goes well, despite the kids still being tired from the two consecutive days of adoption notices. Breakfast is uneventful and I'm particularly glad for it."
  "No one was adopted last night, I shouldn't be glad for it, but I actually am. I decide to take a break from the kids and spend the morning in my room."
  ...
  "I try and smile for him, but the way he looks at me makes the hair on the back of my neck stand up. There was something in his eyes that makes his gaze so... strong. It's a little scary."
  ...
  j "This is Dr. Moore. Since you and the other Felixes are going to be seeing him quite a bit I want you two to get along quick, okay?"
  ...
  j "He can give massages, is soft and nice to pet, and he always seems to be smiling. He also helps me out with the Felixes who are still for sale all the time. The kids really look up to him."
...
label stay:
  ...
  "I've been playing with shapes lately. There are some books in the library that are full of famous painter's works. I like to look through them sometimes."
  ...
  show lukas at zoom_off

  "Dr. Kronauer has always been this worried about me. He hates seeing me get sick. He's always so worried about me, like he did something to cause it, since he has to test his medicine on me sometimes."
...
label follow:
  ...
  j "This here is the classroom: the children have classes on reading, writing, math, and health when they transfer here up until they leave. Our curriculum is pretty basic, and once they turn 12 they are allowed to stop if they choose." 
  ...
  menu:
    "Candy!":
      a "Everyone loves candy here."
      $ candy = True
      jump continueday1
    "Stickers.":
      a "Stickers would be more fun and better for the kitten' tummies too."
      jump continueday1
      $ stickers = True
    "Both!":
      $ steven_points += 1
...
label continueday1:
  ...
  j "That sounds wonderful. Addy, we have to talk about some things privately. Will you excuse us?"
  a thinking "Oh, okay."
...
label lunchday1:
  ...
  "We sit and eat and laugh a little longer. Eventually, we set the dishes aside and I flop over, resting my head in Dr. Kronauer's lap while he strokes my hair and talks to me." 
  ...
  "Looks like it's one o'clock already. I can't stay in my room or I'll probably fall asleep again. Instead, I get up and stretch. A round of games in the playroom sounds nice."
  ...
  "Before I can even talk to the kids though, someone grasps my arm."
  
  show pumpkin nervous 
  with easeinright #ease in right

  a surprised "???"
  p nervous "Addison- can I talk to you?"
  a "Sure- what's wrong?"

  "Even though we're around the same age, we don't talk much. Sometimes he helps out the kids with their lessons or plays games with them like I would do, but I think he likes smaller groups instead of taking care of all the kids at once."
  "Even his giant personality can't compete with a big crowd of kids."

  p "Nothing's wrong, I just wanted to talk. Well, actually... It's not wrong but it's new! the management is going to take me off the sales list, like you! I'm also going to be given the job 'Brand Mascot!'"
  a surprised "Wait, taken off the sales list? You wouldn't be adopted?"
  p "Yeah, I just have to pass a test tomorrow."
  a "A test? What kind of test? What would your job be? I didn't think they would do that with anyone else."
  p happy "Yeah, it's new, huh? They would take pretty pictures and videos of me to make me really pretty. It would make people want to adopt Felixes more. That's what they told me, anyways. Isn't it great?"
  ...
  "I'm glad he's taking it so well. I guess it's for a different reason, but I was crushed when I learned that I wasn't going to be adopted. It was really hard on me and I felt awful for months. But… it’s good for him if he passes the test. Even now he's smiling right at me."

  p "Isn't it?"

  p nervous "But the test tomorrow--it's after our shots. I'm sure I'll be really good at it! But..."

  "I know where this is going."

  a "You're nervous."
  p "Yeah... A little, I guess."
  a "Like you said, you'll do great. What's the test?"
  p "I think it's just pictures to make sure I'm pretty enough..."
  a "Pumpkin, you're beautiful! Of course you're going to pass!"

  p excited "Yeah! Of course I am!"

  "I don't know if I should ask or not, but I'm worried about something else."
  "Does he really want to pass?"
  "Maybe I'm assuming too much. He doesn't have to react the same way I did. Maybe he really doesn't mind not being adopted."
  "We sit and chat a while longer. Pumpkin even rests his head on my shoulder. It's nice to spend time with him alone for a change. I feel like I don't know him well enough."
  ...
  "Pumpkin doesn't sit with me for dinner. I guess he asked all the questions he wanted to."
