...
label day3:
  calendar day 3
  "Already morning? I stretch and feel my back crack with a satisfying 'pop.' I hope I'm not getting old. That pop still feels good, so I don't think so."
  ...
  "I lean against the wall, letting my mind wander. However weird he acted, Dr. Moore is still pretty handsome, so it isn't too hard to imagine him relaxing a little if he spent some time with me."
  ...
  p nervous "Ha, that's okay. Is it okay if I stand with you?"
  ...
  p "They said they would feed me lunch there."
  a "Oh..."
...
label flirt:
  ...
  show steven angry at zoom_off

  s angry "Addison, stop."
  a thinking "O-Okay."
  a sad "Sorry, I'll go."
  s sad "No Addison, I'm not angry with you. Just- Don't kiss me. I know you're... used to being personal with everyone, but I would rather not."

  "So he doesn't want me around?"

  a "Okay... Do you want me to leave you alone?"
  s sigh "Yes. I mean. No, I needed to ask you something. I want to get to know you. I just don't want- I don't like being touched without permission."
  a "Oh." 
...
label continueday3:
  ...
  s "We don't have a lot of time right now, but I know you like to help out a lot, so I wanted to ask for your help. There's a lot of Felixes here I don't know and it's going to take me awhile to get used to this place."
  ...
  if stickers == True:
    "He grins and reaches over to a bowl on the counter, offering me a peice of paper in the shape of a square."
    s "I brought stickers today. The kids have been liking them so far."
    
  if candy == True:
    "I take a peice of candy from his bowl before leaving."
...
label followpumpkin:
  ...
  a "Yeah of course I'll come with! I'll get to see you all pretty and it's my job as your big brother to help out. Don't worry, I'll wait."
  ...
  o "You'll be making promotional material for Helix, both photography and video. You're going to be modeling lots of clothes and eventually doing product and location shoots."
  ...
  o "I thought you might say that. Today we're going to just be doing photography so you can get used to the makeup and clothes. How does that sound?"
  p excited "Yes!"
  ...
  "Before I know it, Mr. Jesse and the lady are whisking Pumpkin away. I try to stand and follow, but from the looks on everyone's faces... "
  ...
  "But the cameraman gives him a lot of directions, and by his third set of clothes I wouldn't be able to tell if his poses from that thin book the lady had shown us before."
  ...
  "There's a table filled with snacks and paper plates. It certainly does not look like lunch from the cafeteria or from Dr. Kronauer either."

  p "Those lights are really hot, but I'm having a lot of fun! Do I look good?"
  a "Yeah, you look great. I liked those scarves you had."
  ...
  p "I'll eventuallyget to try all of them on!"
  a "I'm glad you're having fun."
  p excited "Yep! After this they said that someone else will take pictures with me too."
  a thinking "Someone else?"
  p nervous "Yeah, someone pretending to be my Master."
  ...
  "It's obvious Pumpkin doesn't have that kind of problem."
  ...
  "It goes on like this for a few more hours. I really didn't think that it would be an all-day event."
  "Pumpkin changed back into his facility clothes, then he startles me from a daydream as he starts jabbering excitedly."

  show pumpkin excited
  with dissolve

  p "Addy! Wasn't that super fun?! I'm so excited, but boy I'm tired. It's a lot of work being this cute! Come on, we gotta eat something before we leave-- dinner is already over. What was your favorite part? Did you see Samuel? He was my fake Master. He's pretty cute, don't you think? These crackers are really good. I want to get out of here so bad. Augh- come on, grab a whole plate of stuff and let's go!"
  ...
  p happy "I found it a really long time ago. Then I saved up sheets or holiday decorations that Mr. Jesse was throwing out. I've even got pillows, and Christmas lights, and-"
  a "You put all of this together?"
  ...
  "Really, it was like a blanket fort that the kids would make, but it's lit up and it feels so much cozier too."
  ...
  "I scoot over to the wall, one of the blankets draped from the ceiling brushing against my ear."
  ...
  p "It took a long time, but it's perfect now."
  ...
  a "No- wont everyone notice you're gone? I don't want you to get in trouble or for anyone to find out about this place."
  p "Mmmhhhh…"
  "He rolls over."
  ...
  "We quietly tiptoe our way back and I open the door to the kids room as slowly as possible."
...
label followlukas:
  ...
  a sad "Dr. Kronauer is really... sensitive. He'll be sad if I don't come."
  p sad "Oh, okay. I'll see you later then."
  ...
  "I turn the other direction and hurry down the hall to the stairs and up to Dr. Kronauer's office."
  ...
  l sad smile "Oh, Addison. I'm still in the middle of work, but you can sit with me for awhile. That would be great."
  a "Sure ... Are you okay?"
...
label askaboutnumbers:
  ...
  l confused "Why are you asking me?"
  a nervous "Well he, he's a little hard to talk to."
  l happy "Ha, you can say that again. Uh... yeah, he probably had never seen one before he came here. Why do you ask?" 
...
label heatfood:
  ...
  l confused "Oh, what are you doing?"
  ...
  "Lots of numbers and lots of other things I don't even understand. I set my hands on his shoulders and wonder..."
  ...
  "I learned a while ago how to do it, the management brought someone in to teach me. It was really nice to have the classes all to myself-- it made me feel really special. I don't rub people much though, unless it's at their desks."
...
label continueride:
  ...
  "He lets go of me and I sit on the floor next to his legs, leaning against him, grinning as his hand running through my hair. I occupy myself with just enjoying the feeling for awhile, but even the best trained Felixes get bored."
  ...
  "I talk to anyone I can at dinner, about anything. Letting the kids ramble on about their new favorite toys or stories, it's calming to just nod and listen along. The way their faces light up is enough to feed me too."
