...
label day4:
  ...
  "Another morning and another big knot in my tail. The hair is so long it feels like it takes me ages to comb it out as I sit and brush it at my desk."
  ...
  "I pile the scrambled eggs filled with leftover meat high on my plate and I take a seat." 
  "Can I really handle doing three different jobs? Already I have to be a Big Brother to the kids, and of course I have to be the Staff Companion."
...
label menuday4:
  ...
  menu:
    "I was born as a girl.":
      ...
      s "I saw that on your chart. It looks like everything is going well, though. I noticed you're not on hormones, would you like to be?"
    ...
    "I'm the Staff Companion.":
      $ steven_points -= 1
      a "I'm the Staff Companion, so I know almost everybody here, not just the kids. I can introduce you to people if you wan-"
      "He cuts me off"
...
label artyes:
  ...
  "What is good? What should I show him? I end up grabbing a few haphazardly, my cheeks and ears burning."
  ...
  a "I didn't, I just looked at pictures and tried to copy them..."
...
label artno:
  ...
  a nod "Yes, before you came here, had you ever seen one? When we first met, you just looked... confused."
  ...
  s sigh "There are about 12 billion humans on Earth. That would be more than one million people for every one Felix."
  ...
  a "Actually, is it okay if I go to lunch now? I can come back after lunch."
  s thinking "Of course. You don't have to stay here with me if you don't want to. I'd never keep you here."
  a happy "Okay. Well, I'll be back."
  ...
  "He taps at his computer a bit while we sit, but he's not as distracted like the last time."

  a "How many is a million?"
  l confused "Hm?"
  a "How many is a million? Dr. Moore said there's a million humans for every one Felix."
  l "Really?"
  ...
  "My bed sounds fantastic right about now, but it's still too early to go to sleep, or even to put the kids to sleep. Instead, I sprawl out with my colored pencils and coloring books, picking a page with an abstract swirling circle to keep me occupied." 
  ...
  l "Probably. But I have some medicine I need you to try first."
