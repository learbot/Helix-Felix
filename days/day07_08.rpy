...
label day7:
  ...
  "The smell of maple syrup is thick and only fuels my smile. I lean over my tray, face in my hands, and watch over the kids while I eat. It's a bit too sugary for my taste, but the kids go wild for the syrup. I've spread my pancakes thick with butter."
  "As we're cleaning up, Charlie starts to mope."

  show charlie sad
  with dissolve

  a "Hey now, what's wrong?"
  c "I have clean-up today."
  ...
  "Pumpkin has been missing from our daily meals lately, and with all my work in the clinic and his work with pictures, He and I weren’t able to spend time with the kids or with each other."
...
label overhear:
  ...
  "He doesn't seem to mind as I slip away. I don't like to get caught up in a rumor or office politics. I've done it too many times already, being someone who gets to hear everything from everyone (people say a lot more than they should while they're comfortable petting me.) so I try to ignore Dr. Moore's muttering."
  ...
  "We sit on the bed and I'm already nibbling on the celery sticks and peanut butter he brought. The rest of my meal is too hot to sit in my lap, so I'm waiting for it to cool."
...
label skiporalday7:
  ...
  o "Haven't seen you in a minute."
  ...
  "The staff fed me donuts, so I really don't mind that I missed dinner. Instead, I decide to head straight to the kid's room to help everyone in their pajamas after showers and read some books to them."
  ...
  "I squirm to one side of the bed. Dr. Kronauer settles in besides me in a way that reminds me of when kids would sleepwalk while I was still in the barracks."
...
label lukasgone:
  ...
  "When I wake up… Dr. Kronauer is gone. I don't know if I expected him to be here or not. I hope he gets the rest he needed."
...
label headtoart:
  ...
  "Picking up the boxes, I realize they're all full of colors. There's more crayons, pencils, pens, paints, watercolors, watercolor… pencils? Even a pack of paper in different colors."
...
#lukas points: -1 to 3
  ...
  menu:
    "Dr. Moore" if (steven_points>=2) or debug_test:
      "Of course, because he gave me all these wonderful supplies in the first place. He's been so kind to me, even though he started out to be a shy person. In the end, he’s now giving me all those stuff to show his kindness. I should return the favor right now!"
      $ steven_points += 2
      $ giftsteven = True
      jump giftmaking
...
#######################
  ...
  a smile "I'll have to let it dry just a minute longer. What time is it?"
...
label giftsteven:
  ...
  "Especially if I'm not allowed to kiss him."
  ...
  s sad smile "Haha, well, if you think of anything."
...
label day8end:
  ...
  "I haven't had this much fun in a very long time. Even now, I can't stop smiling."
