...
label day9:
  ...
  "The kids want to play a game of hide and seek, so naturally I'm 'it'."
  "This makes it hard, some of the younger kids are bad at hiding and I'm not sure if I should pretend that they're good, or let them know I can see their ears over the couch."
  ...
  "Pumpkin puts the extra in his pocket and winks."
  ...
  "The kids are busy eating and don't notice me slip out with Pumpkin. He takes my hand, guiding me down the twisting hallways."
...
label nextday9:
  ...
  a "What about you? What did you dream about when thinking about a Master?"
  ...
  p "Huh?"
  a "What would you want from a Master?"
...
label heavyday9:
  ...
  p "Hmm. Well, do you know why he likes you? Other than you're ~so cute~."
  a "Hey. Well, we're friends. When I found out I couldn't be adopted because I was trans, I was 12. They put Dr. Kronauer in charge of me, so that I could test his medicines. He just liked to talk to me, and I trusted him when I was scared or sad. In the beginning, I was sad a lot. And when I turned 18 and they said I could have sex, I was really nervous and scared. He was the one who told me I could say 'no', and wait as long as I needed, or never do it at all. And then one night when I was in heat, it just felt... right. I trusted him ever since."
  ...
  p "Yeah... You know, even with your picture, my new room feels so empty. It's hard to sleep with everything so quiet. I miss hearing the kids sleeping around me."

  a "It took me awhile after I moved from the barracks to get used to that too."
...
label saturdaysleep:
  ...
  "My bed is a little small for two, but we curled into each other and I'm struck with a memory from a long, long time ago, there were some nap times where we curl into each other like this on the floor. I don't remember doing it with Pumpkin specifically, but we fit together so well, and it brings a smile to my face."
...
label cuddleday9:
  ...
  "I don't know how long it was, but we tangled into each other for a while. Holding Pumpkin against me, this reminds me that he's only 18 now. That's old for Felixes who live here, but... He's going through a lot right now. Being 18 was hard for me too, but looking back, it feels like forever when it's only been four years since then."
...
label movethings:
  ...
  "I think I might have offended him, so I changed the topic and we chitter away for a while longer, eventually crawling out to wash and put away the mugs we had 'borrowed'. It's getting late and I need to check on the kids again."
  ...
  "I check on the kids-, they're all sleeping soundly in their beds-, so I head to mine to crash for the night."
