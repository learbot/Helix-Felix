...
label day10:
  ...
  "Happy monday."
  "None of the kids or the staff like Monday because classes and work start again for the week. Since I stopped taking classes though, the edge of Mondays have worn off."
  ...
  hide image charliesad onlayer event
  with dissolve
  $ config.side_image_tag = None

  "The other kids are upset as well, but I have to stay with Charlie."
...
label checkonsteven:
  ...
  $ config.side_image_tag ="alfa"
  show stevencrying onlayer event
  with dissolve 
  ...
  hide stevencrying onlayer event
  with dissolve
...
label continueday10:
  ...
  "I pick at my meatloaf while I think, the kids quiet and somber as they eat."
